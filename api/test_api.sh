...
curl -X POST "http://0.0.0.0:7880/video2audio" \
     -H "Content-Type: application/json" \
     -d '{"video_path": "/workspace/tmp/00000000000000000000000000000012/soundful_video_ff399c40-f9ee-46b6-8043-b51ddee54e73.mp4", "user_id": "00000000000000000000000000000012"}'
